    ...
    export default{
        data(){
            return {
                item:{},
                dulieu:[],
                imageSrc: 'https://hoanguyenit.com/public/img/logo33.png',
            }
        },
        created:function(){
            this.getItems();
        ...
        methods:{
            addItem(){
                this.axios.post("https://localhost:8000/add",this.item).then((response) => {
            ...
            updateItem(){
                ...
                this.axios.post("https://localhost:8000/update",this.item).then((response) => {
            ...
            deleteItem(index){
                ...
                //console.log(masp);
                this.axios.get("https://localhost:8000/delete/"+masp).then((response)=>{
            ...
            getItems(){
                ...
                this.axios.get("https://localhost:8000/getItems").then((response) => {
            ...
            uploadImage: function(e) {
                 ...
                 var data = new FormData();
                  data.append('image', files[0]);
                      ...
                      this.axios.post('https://localhost:8000/uploads', data, {headers: { 'Content-Type': 'multipart/form-data' } }).then(function (response) {
